...
Sennheiser TeamConnect Ceiling 2 \gls{microphone}. We did so by creating five
...
tracking work best in cases where there are fewer restrictions on how
...
To facilitate all the above-mentioned tracking models, an API was developed
for the camera and \gls{microphone} to communicate with the hardware that is used for
...
the camera and microphone APIs features, calibrate and control the flow of
...
visualization of the camera’s and the \gls{microphone}’s directions and footage
...
Because of our workflow practices, the software is tested with 92\% line coverage
...
Multiple things can be improved, which can vary from an
