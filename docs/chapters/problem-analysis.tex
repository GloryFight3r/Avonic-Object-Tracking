...
As a company, Avonic would like to make it easier to record educational sessions by creating a camera that follows the speaker as he or she
moves around in a room. For example a camera could be in the back of a lecture hall, and a microphone in the front, next to the
...
\subsection{AVer}
AVer created a camera that can “automatically track a presenter’s face and movements.”[REF] The camera
...
to localize the sound and track the speaker.[REF] As audio from a microphone array is used to detect the speaker's location, this is similar
...
speaker.[REF] This dual-camera approach helps to switch quickly between different speakers. It can be compared to the dual-lens design used
...
responsible for its acceptance.”[REF]
