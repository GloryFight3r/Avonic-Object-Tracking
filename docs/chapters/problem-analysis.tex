...
(figure ) and the
microphone is the Sennheiser TeamConnect Ceiling 2 (figure ).
...
tracking and the is most important to them.
...
Some of the criteria we use to determine whether code is well written are test
coverage, readability and extensibility. These criteria and more are explained
in \hyperref[ch:workflow-and-teamwork]{Chapter 5} where we talk about the
workflow.

\paragraph{Avonic}\mbox{} \\
Avonic as a company influences the requirements of our project. They have the
...
report can be used by Avonic to decide whether the experiment is worth doing
again.
