...
We have chosen the scenario where we look for an intersection of the ray from the microphone with the ``speaker plane''̈ as the plane is the most probable scenario for the presenter's environment.
