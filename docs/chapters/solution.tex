...
\begin{figure}[h]
    \caption{States diagram of the switch strategy, which combines object detection with audio information}
    \centering
...
when there is an \hyperref[subsection:mic]{active speaker}, but furthermore, adjusts the camera based on
...
is subsequently used to track the speaker until being explicitely stopped by the user.
...
described in \hyperref[the section about calibration]{sec:calibration}. The
...
tracking. Sometimes the camera zoomes in or out unexpectedly or too much.
...
explained in section about \hyperref[Visual object
tracking]{sec:visual-object-tracking} we chose to use YOLO for our object
...
The WebUI was moved from a “should have” to a “must have” section after
