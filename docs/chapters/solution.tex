...
despite its claim to improved performance, we noticed that in practice the YOLO algorithm was multiple times faster (on one PC, 2, to be precise)
...
closest to his new bounding box in the new frame. Assuming that, we get
all the new bounding boxes from the new frame and choose to track the one
