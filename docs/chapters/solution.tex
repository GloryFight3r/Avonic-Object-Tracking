...
Because the system cannot contain any extra device, that would give us extra information about the system's deployment environment, assumptions need to be made.
...
\textbf{THERE WILL BE DOCUMENTATION AND GENERAL DESCRIPTION OF THE MODULE}
...
We have decided to use Flask as it is a well-known light-weight framework, that allows for web development.
...
It is also used by Avonic themselves and was recommended by the client.
The front-end is written in HTML, CSS and JavaScript and includes controls for the camera, the information from the microphone, and a visualization all on a single page.
