...
This model’s point method also takes into account how far the speaker is from the camera and zooms in accordingly if this option is enabled.
Another improvement we implemented is changing the camera speed depending on how much it has to move.
