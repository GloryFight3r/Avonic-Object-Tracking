...
\end{enumerate}
Through the process of the research and iteration, with the amount of time we are given, taking in account all of the limitations, we have identified these assumptions as minimal.
...
But as our system is closed under only 2 devices, and microphone's API does not have a way to retrieve distance, the assumption needed to be made to somehow describe the distance function in the environment.
We have chosen the scenario where we look for intersection of the ray from the microphone with the "speaker plane", as the plane is the most probable scenario for the presenter's environment.
