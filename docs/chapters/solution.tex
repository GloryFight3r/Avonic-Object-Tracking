...
when there is an active speaker(by active speaker we understand a person, who is 
currently speaking and the Sennheiser microphone is able to detect his voice and is 
greater than the speak threshold), but furthermore, adjust the camera based on
camera footage and bounding boxes we get from it. When there is an active speaker, we first
search for his location using the microphone information. If he is in the FoV(Field of View)
