...
brainstormed and came up with solutions together. Mattermost served as a
...
At the beginning of the project it was outlined, that the system should be capable of running on NVIDIA Jetson Nano \textbf{(reference)}.
