...
As described in subsection \ref{subsection:solution_webui} on WebUI,
...
by a different choice of the framework for the WebUI or by a proper
implementation of the dependency injection.
...
When discussing object detecting models with Avonic, we discovered that they use
in-house version of YOLO ported to TensorRT, which allows for better performance
of the model. This would reduce load of the system, allowing for more features,
