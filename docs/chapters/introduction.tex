...
but they become inaccurate when there are more people to capture (e.g. two lecturers on opposite sides of the stage).
...
and if it is more accurate and useful than using only object tracking from the video stream directly.
...
\hyperref[ch:workflow]{Chapter 5} gives an insight into our team workflow and how we collaborated with Avonic.
