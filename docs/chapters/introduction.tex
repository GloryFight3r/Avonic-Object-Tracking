...
research and results of devising a system which directs a camera at the orator in a conference
using the Sennheiser TeamConnect 2\cite{team-connect-2} and Avonic’s PTZ (pan-tilt-zoom) camera.
...
We perform this experiment on behalf of Avonic in the span of ten weeks.
...
\hyperref[ch:solution]{Chapter 3} will include the solution engineering process -- detail the solution we selected, its alternatives and reasons for picking the one we did.
The requirements and how they were changed with the development of the project are described in \hyperref[ch:requirements]{Chapter 4}.
