...
We have ordered them using the MoSCoW method \cite{moscow} which we will describe in (4.1). 
...
First, the requirements are divided into two sections.
\begin{itemize}
...
\end{itemize}
Furthermore, since we have a limited amount of time, we decided to prioritise the functional requirements in order to make progress 
...
\begin{itemize}
  ...
  \item \textbf{W}ont have - Requirements that are perceived as the least-critical by stakeholders. This
