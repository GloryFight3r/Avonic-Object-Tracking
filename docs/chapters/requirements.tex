...
We have ordered them using the MoSCoW method\cite{moscow} which we will describe in \hyperref[]{(4.1)}. %TODO
All of the requirements fall under one of the following categories ‘Must-have’,
‘Should-have’, ‘Could-have’, ‘Won't-have’. This follows the MoSCoW method described in
\hyperref[ch:moscow-appendix]{Appendix D}.
Furthermore, we also list some non-functional requirements we have for our system.
Final requirements are listed in \hyperref[]{(4.2)}. %TODO
Finally, we also go through the evolution of the requirements in \hyperref[]{(4.3)}. %TODO
\hyperref[ch:requirements-appendix]{Appendix B - Requirements table} shows for
each requirement whether it has been completed or not.
...
Since the beginning of the project we have come up with few new requirements and have got rid of others we have deemed unnecessary.
