...
def generate_get_direction_commands():
    return [
        ...
        ([0.0625, 0.0625], b'\x90\x50\x00\x00\x00\x01\x00\x00\x00\x01\xFF'),
        ([43.75, 0.0625], b'\x90\x50\x00\x02\x0B\x0C\x00\x00\x00\x01\xFF'),
        ([0.0625, 43.75], b'\x90\x50\x00\x00\x00\x01\x00\x02\x0B\x0C\xFF'),
        ([-152.9375, -27.625], b'\x90\x50\x0F\x06\x07\x00\x0F\x0E\x04\x05\xFF'),
    ]
