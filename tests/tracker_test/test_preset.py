...
def test_get_preset_lists(preset_collection: PresetCollection):
    preset_collection.add_preset("preset", np.array([1, 2]), np.array([1, 2, 3]))
    preset_collection.add_preset("preset2", np.array([1, 2]), np.array([1, 2, 3]))
    preset_collection.add_preset("preset3", np.array([1, 2]), np.array([1, 2, 3]))
    preset_collection.add_preset("preset4", np.array([1, 2]), np.array([1, 2, 3]))
...
def test_get_preset_info(preset_collection: PresetCollection):
    preset_collection.add_preset("preset", np.array([1, 2]), np.array([1, 2, 3]))
    preset_collection.add_preset("preset2", np.array([2, 3]), np.array([4, 5, 6]))
    preset_collection.add_preset("preset3", np.array([3, 4]), np.array([7, 8, 9]))
